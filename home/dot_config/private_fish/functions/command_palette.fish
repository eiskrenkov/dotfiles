function command_palette --description "fzf modal of dotfile features (tmux prefix+P / ⌘⇧P)"
    ...
    __cp cld       "Claude · launch (skip perms)"           ""       pane    "claude-dangerously-skip-permissions"
    __cp cldopus   "Claude · launch Opus (skip perms)"      ""       pane    "claude-dangerously-skip-permissions-opus"
    __cp cldfable  "Claude · launch Fable (skip perms)"     ""       pane    "claude-dangerously-skip-permissions-fable"
